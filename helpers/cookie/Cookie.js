/**
 * The cookie library which runs in the browser invironment.
 * To inject it from the NodeJS environment use puppeteer evaluate() method:
 *
 * const cookie = new Cookie(cookieOpts, false);
 * const result = await page.evaluate(cookie => {
